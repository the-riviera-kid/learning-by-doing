...
def search_movies_by_actor(movie_list, main_menu):
    ...
    while not search_complete:
        movies_starring_actor, requested_actor = movies_by_actor(movie_list)
        search_complete = print_movies_starring_actor(movies_starring_actor, main_menu, requested_actor, search_complete)


def movies_by_actor(movie_list):
    ...
    return movies_starring_actor, requested_actor


def print_movies_starring_actor(movies_starring_actor, main_menu, requested_actor, search_complete):
    if movies_starring_actor:
        ...
        return main_menu, search_complete
...
def search_movies_by_genre(movie_list, main_menu):
    search_complete = False
    while not search_complete:
        genre_list, genre = movies_by_genre(movie_list)
        search_complete = print_movies_by_genre(genre_list, genre, search_complete, main_menu)

def movies_by_genre(movie_list):
...
def print_movies_by_genre(genre_list, genre, search_complete, main_menu):
    if genre_list:
        ...
        return search_complete
    return search_complete, main_menu
...
def add_new_movie(movie_list, main_menu, title, actors, year, genre, rating, add_complete):
    ...
    return movie_list, main_menu, add_complete
