...
def main():
    ...
    while blanks_are_left(word, correct_guesses) and guesses_remaining > 0:
        user_letter = play_game(word, correct_guesses, guesses_remaining)
...
def play_game(word, correct_guesses, guesses_remaining):
    user_letter = get_user_guess()
    print_result(word, user_letter, correct_guesses, guesses_remaining)
    return user_letter
...
def print_result(word, user_letter, correct_guesses, guesses_remaining):
    for letter in word:
